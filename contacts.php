   ...
   <body class="cont-page">
        ...
        <div id="content" class="clearfix">
            <div id="searchbox">
                <div>
                    <div class="heading">
                        <h1 class="logo"><a class="navbar-brand" href="/"><img class="contact-img" src= https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5kI-33wu7evbFveZT3rOWNRIpqns65z-0rA&usqp=CAU width="40" height="50"></a></h1>
